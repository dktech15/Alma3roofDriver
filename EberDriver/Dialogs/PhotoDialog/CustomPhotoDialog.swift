...
public class CustomPhotoDialog:CustomDialog, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    public static func showPhotoDialog(_ withTitle:String, allowsEditing: Bool = false, andParent:UIViewController) -> CustomPhotoDialog {
        ...
        view.allowsEditing = allowsEditing
