...
//  Edelivery
//
//  Created by Jaydeep on 07/06/18.
...
class MonthYearPickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func commonSetup() {
        ...
        for _ in 1...12 {
            ...
            dateFormat.locale = Locale.init(identifier: preferenceHelper.getLanguageCode())
            months.append(dateFormat.monthSymbols[month].capitalized)
            month += 1
        }
        self.months = months
