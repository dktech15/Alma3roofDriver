...
struct InvoiceTrip : Codable {
    ...
    var walletCurrentRate : Double = 0.0
    var walletPayment : Double = 0.0
    
    var carRentalId : String = ""
    var is_payment_pending: Bool = false
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case cityId = "city_id"
        case completeDateInCityTimezone = "complete_date_in_city_timezone"
        ...
        case walletCurrentRate = "wallet_current_rate"
        case walletPayment = "wallet_payment"
        case payment_url = "payment_url"
        case is_payment_pending = "is_payment_pending"
    ...
    init(from decoder: Decoder) throws {
        ...
        completeDateInCityTimezone = try values.decodeIfPresent(String.self, forKey: .completeDateInCityTimezone) ?? ""
        ...
        paymentStatus = try values.decodeIfPresent(Int.self, forKey: .paymentStatus) ?? 0
        ...
        walletCurrentRate = try values.decodeIfPresent(Double.self, forKey: .walletCurrentRate) ?? 0.0
        ...
        is_payment_pending = try values.decodeIfPresent(Bool.self, forKey: .is_payment_pending) ?? false
    }
