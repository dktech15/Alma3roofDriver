...
open class PBRevealViewController: UIViewController, UIGestureRecognizerDelegate {
     ...
     */
    open var leftViewRevealWidth: CGFloat = UIScreen.main.bounds.size.width - 80{
        didSet {
            ...
            if self.isLeftViewOpen {
                ...
                if !self.isLeftPresentViewOnTop {
                    ...
                    //self.mainViewController?.view.alpha = 0.6
                }
            }
        }
    }
     ...
     */
    open var rightViewRevealWidth: CGFloat = UIScreen.main.bounds.size.width - 80 {
        didSet {
     ...
     */
    @objc public init(sideViewController: UIViewController?, mainViewController: UIViewController) {
        ...
        self.leftViewController = sideViewController
        //        if arrForLanguages[preferenceHelper.getLanguage()].code == "ar" {
        //            self.rightViewController = sideViewController
        //        }
        //        else {
        //            self.leftViewController = sideViewController
        //        }
    ...
    private func loadStoryboardControllers() {
        ...
        if (self.storyboard != nil) && leftViewController == nil {
            ...
            //self.performSegue(withIdentifier: PBSegueLeftIdentifier, sender: nil)
            self.performSegue(withIdentifier: PBSegueMainIdentifier, sender: nil)
            self.performSegue(withIdentifier: PBSegueLeftIdentifier, sender: nil)
        }
    }
     ...
     */
    @IBAction @objc open func revealSideView() {
